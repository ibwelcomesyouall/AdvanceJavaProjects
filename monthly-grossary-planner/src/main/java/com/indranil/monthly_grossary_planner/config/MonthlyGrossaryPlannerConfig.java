package com.indranil.monthly_grossary_planner.config;
...
@ComponentScan(basePackages="com.indranil.monthly_grossary_planner")
@PropertySource({ "classpath:persistence-mysql.properties","classpath:security-persistence-mysql.properties" })
public class MonthlyGrossaryPlannerConfig {
